...
Tranlsation units, a map file for functions with external linkage, the global call graph.
...
have inherently imprecise assumptions about external functions. We plan to
